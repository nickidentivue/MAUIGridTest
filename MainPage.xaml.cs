...
public partial class MainPage : ContentPage
{
    ...
    void CreateWideButton()
    {
        ...
        grid.Add(new Label { Margin = 20, BackgroundColor = Color.FromRgba(0.7f, 0.6f, 0f, 0.5f), Text = "Column span = 1", VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Center });
